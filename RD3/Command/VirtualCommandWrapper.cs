...
namespace RD3.Shared
{
    public class VirtualCommandWrapper : ICommandWrapper
    {
        ...
        {
            return Tuple.Create(RandomNumberUtil.GetRandomInt(0, 2), RandomNumberUtil.GetRandomInt(0, 2));
        }
        ...
        public RealTimeParam GetRealTime(string insID)
        {
            ...
            realTime.PH = AppSession.VirtualpH;
            realTime.DO = AppSession.VirtualDO;
