...
{
    class PadCalibrationViewModel : BaseViewModel,IDialogAware,IConfigureService
    {
        ...
        private SensorType_5L _sensorType = SensorType_5L.PT100;
        public SensorType_5L SensorType
        {
            get => _sensorType;
            set 
            {
                ...
                if (CalibrateIndex == 0 || CalibrateIndex == 1 && value != SensorType_5L.DO)
                {
                    Calibrate2Enabled = false;
                    Calibrate1Enabled = true;
                }
                else if (CalibrateIndex == 1 && value == SensorType_5L.DO)
                {
        ...
        public int CalibrateIndex
        {
            ...
            {
                //如果系数校准和偏置校准且非DO校准，校准2不使能
                if (value == 0 || value == 1 && SensorType != SensorType_5L.DO)
                {
                    Calibrate2Enabled = false;
                    Calibrate1Enabled = true;
                }
                else if (value == 1 && SensorType == SensorType_5L.DO)
                {
                    Calibrate1Enabled = false;
                    Calibrate2Enabled = true;
                }
        ...
        public PadCalibrationViewModel(IContainerProvider containerProvider, IDialogHostService dialogHostService) : base(containerProvider, dialogHostService)
        {
            ...
            worker.DoWork += (s, e) =>
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        switch (SensorType)
                        {
                            case SensorType_5L.pH:
                                CurrentValue = (float)realTimeParam.PH;
                                break;
                            case SensorType_5L.DO:
                                CurrentValue = (float)realTimeParam.DO;
                                break;
                            case SensorType_5L.JarWeight:
                                CurrentValue = (float)realTimeParam.JarWeight;
                                break;
                            case SensorType_5L.ReserveWeight:
                                CurrentValue = (float)realTimeParam.JarWeight;
                                break;
                            case SensorType_5L.Bottle1Weight:
                                CurrentValue = (float)realTimeParam.Bottle1Weight;
                                break;
                            case SensorType_5L.Bottle2Weight:
                                CurrentValue = (float)realTimeParam.Bottle2Weight;
                                break;
                            case SensorType_5L.PT100:
                                CurrentValue = (float)realTimeParam.Temp;
                                break;
                            case SensorType_5L.pHTemp:
                                CurrentValue = (float)realTimeParam.PHSensorTemp;
                                break;
                            case SensorType_5L.DOTemp:
                                CurrentValue = (float)realTimeParam.DOSensorTemp;
                                break;
                            case SensorType_5L.HeatBlanketNTC:
                                CurrentValue = (float)realTimeParam.HeatingBlanketNTCTemp;
                                break;
                            case SensorType_5L.RoomTempNTC:
                                CurrentValue = (float)realTimeParam.RoomTemp;
                                break;
                        }
                    }
                    catch (Exception ex)
            ...
            worker1.DoWork += (s, e) =>
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        if (SensorType == SensorType_5L.pH || SensorType == SensorType_5L.DO)
                        {
                            if (StatusCode == 0)
                            {
